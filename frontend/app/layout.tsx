...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${plusJakarta.variable} ${geistMono.variable} ${cormorant.variable} ${playfair.variable} ${lora.variable} ${dmSans.variable} ${nunito.variable} h-full antialiased`}
    >
