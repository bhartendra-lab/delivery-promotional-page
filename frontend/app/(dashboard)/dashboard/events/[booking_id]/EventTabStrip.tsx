...
export function EventTabStrip({
  ...
  return (
    <div
      ...
      className="flex shrink-0 items-stretch gap-1 overflow-x-auto border-b border-t border-[var(--color-brand-border)] bg-white px-4 sm:px-10 md:overflow-x-visible"
    >
      {tabs.map((t) => {
