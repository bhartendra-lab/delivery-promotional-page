 ...
 * republish. Uploading media generates embeddings immediately, but that
 * background processing is deliberately NOT shown to the studio: the pill is a
 * status indicator with exactly one control, deactivate/reactivate.
 *
 *   live        — gallery live → green pill, dropdown → Deactivate
 *   deactivated — temporarily off → dropdown → Activate
 */
export type LivePillState = "live" | "deactivated";
