...
export function ShieldIcon({ size = 16, style }: { size?: number; style?: React.CSSProperties }) {
  return (
...
export function ChevronLeftIcon({ size = 16, style }: { size?: number; style?: React.CSSProperties }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.25} strokeLinecap="round" strokeLinejoin="round" style={style}>
